...
//       return a;
//   }
   public static void MidCircle(GL2 gl, int radius, int value){
		float x, y, d; 
		d = 1.25f - radius; 
		x = 0; 
		y = radius; 
		CirclePoint(gl, x, y, value);
		while (x < y) {
			if (d < 0) { 
				//choose E
				d = d + 2*x + 3;
   ...
   public static void DrawPixel(GL2 gl, float x, float y, int value){
	   gl.glPointSize(2.0f);
       gl.glBegin (GL2.GL_POINTS);
   ...
   public static void CirclePoint(GL2 gl, float x, float y, int value){
		   DrawPixel (gl, x, y, value); 
		   DrawPixel (gl, y, x, value); 
		   DrawPixel (gl, y, -x, value); 
		   DrawPixel (gl, x, -y, value); 
		   DrawPixel (gl, -x, -y, value); 
		   DrawPixel (gl, -y,-x, value); 
   ...
   public void init(GLAutoDrawable gld) {
       ...
       gl.glLoadIdentity();
       glu.gluOrtho2D(-25.0, 25.0, -25.0, 25.0);
   }
   @Override
   ...
   public static void main(String[] args) {
      ...
      //creating frame
      final JFrame frame = new JFrame ("Midpoint Circle Algorithm");
